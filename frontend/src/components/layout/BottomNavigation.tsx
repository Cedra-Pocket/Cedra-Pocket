  ...
  return (
    <nav
      ...
      style={{ 
        ...
        maxWidth: 'clamp(300px, 85vw, 380px)'
      }}
      role="navigation"
    ...
    >
      ...
      <button
        ...
        style={{ top: 'clamp(-12px, -3.5vw, -18px)' }}
        aria-label="Home"
      >
        <div className={`
        ...
        `}
        style={{ width: 'clamp(42px, 11vw, 54px)', height: 'clamp(42px, 11vw, 54px)' }}
        >
      ...
      {/* Split nav bars */}
      <div className="flex items-center justify-center" style={{ gap: 'clamp(44px, 12vw, 58px)' }}>
        ...
        <div 
          ...
          style={{
            ...
            borderRadius: 'clamp(12px, 3.5vw, 18px) clamp(20px, 5.5vw, 28px) clamp(12px, 3.5vw, 18px) clamp(12px, 3.5vw, 18px)',
          ...
          <div className="flex items-center justify-evenly w-full">
            ...
            <button
              ...
              style={{ 
                ...
                padding: 'clamp(3px, 0.8vw, 5px) clamp(4px, 1.2vw, 8px)',
            ...
            >
              ...
              <span style={{ fontSize: 'clamp(10px, 2.8vw, 12px)' }} className="font-semibold">Quest</span>
            ...
            >
              ...
              <span style={{ fontSize: 'clamp(10px, 2.8vw, 12px)' }} className="font-semibold">Pet</span>
        ...
        <div 
          ...
          style={{
            background: 'rgba(255, 255, 255, 0.35)',
            backdropFilter: 'blur(24px)',
            borderRadius: 'clamp(20px, 5.5vw, 28px) clamp(12px, 3.5vw, 18px) clamp(12px, 3.5vw, 18px) clamp(12px, 3.5vw, 18px)',
            border: '1px solid rgba(255, 255, 255, 0.3)',
            boxShadow: 'inset 0 1px 0 rgba(255, 255, 255, 0.3)',
            height: 'clamp(48px, 13vw, 62px)',
            padding: '0 clamp(4px, 1.5vw, 8px)',
        ...
        >
          <div className="flex items-center justify-evenly w-full">
            ...
            >
              ...
              <span style={{ fontSize: 'clamp(10px, 2.8vw, 12px)' }} className="font-semibold">Wallet</span>
            ...
            >
              ...
              <span style={{ fontSize: 'clamp(10px, 2.8vw, 12px)' }} className="font-semibold">Game</span>
